class level6_18 extends Phaser.Scene {
  constructor() {
    super({ key: "level6_18" });
  }
  ...
  create() {
    ...
    this.add.sprite(config.width / 2, config.height / 2 - 82, "background18");
    //Cargamos las pools
    this.loadPools();
...
var _platform11 = this.add
.sprite(config.width / 2 - 850, config.height-560, "normalPlat")
.setScale(0.4, 0.6);
this.normalPlatforms.add(_platform11);
_platform11.body.allowGravity = false;
_platform11.body.setImmovable(true);
