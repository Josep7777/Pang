class worldCompleted extends Phaser.Scene {
    ...
    loadText(){
      this.infoText = this.add.bitmapText(config.width - 1880, config.height - 170, 'publicPixelWhite', "",30);
    ...
    create(){
        ...
        switch (gamePrefs.STAGE) {
          ...
          case 6:
            ...
            this.plane = this.add.sprite(this.actualWorldX, this.actualWorldY, "plane").setRotation(35.1);
            this.fly = 2;
            break;
        }
    ...
    update(time, delta){
      this.updateText();
        ...
        switch(this.fly){
          case 1:
            this.infoText.setText("YOU'VE GOT A LONG WAY TO GO.\n\n\nTAKE IT EASY.")
            this.plane.x -= 0.8;
            ...
            break;
          case 2:
            this.infoText.setText("YOU CAN BREAK SOME BLOCKS\n\n\nTHERE ARE HIDDEN SOMEWHERE")
            this.plane.x -= 0.5;
            this.plane.y += 0.8;
