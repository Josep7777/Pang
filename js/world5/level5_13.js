class level5_13 extends Phaser.Scene {
    constructor() {
      super({ key: "level5_13" });
    }
    ...
    create() {
      this.sound.stopAll();
      this.backgroundMusic = this.sound.add("Australia", {
        loop: false,
        volume: 0.5,
      });
    ...
    createStairs() {
      ...
      var _ladder2 = this.add
        .sprite(config.width / 2 - 150, config.height - 285, "ladder")
        .setScale(3);
      ...
      var _ladder3 = this.add
      .sprite(config.width / 2 + 500, config.height - 720, "ladder")
      .setScale(3, 2);
    this.ladder.add(_ladder3);
    _ladder3.body.allowGravity = false;
    _ladder3.body.setImmovable(true);
    ...
    createPlatforms() {
      ...
      .sprite(config.width / 2 - 250, config.height - 330, "destructPlatA")
      .setScale(1.5,0.6);
    ...
    .sprite(config.width / 2 - 400, config.height - 330, "destructPlatA")
    .setScale(1.5,0.6);
  ...
  .sprite(config.width / 2 - 550, config.height - 330, "destructPlatA")
  .setScale(1.5,0.6);
...
.sprite(config.width / 2 + 170, config.height - 330, "destructPlatA")
.setScale(1.5,0.6);
...
.sprite(config.width / 2 + 320, config.height - 330, "destructPlatA")
.setScale(1.5,0.6);
this.destructivePlatforms.add(_platform13);
_platform13.body.allowGravity = false;
_platform13.body.setImmovable(true);

var _platform14 = this.add
.sprite(config.width / 2 + 470, config.height - 330, "destructPlatA")
.setScale(1.5,0.6);
this.destructivePlatforms.add(_platform14);
_platform14.body.allowGravity = false;
_platform14.body.setImmovable(true);

var _platform15 = this.add
.sprite(config.width / 2 + 620, config.height - 330, "destructPlatA")
.setScale(1.5,0.6);
this.destructivePlatforms.add(_platform15);
...
_platform15.body.setImmovable(true);
  ...
  .setScale(3, 0.6);
this.normalPlatforms.add(_platform16);
_platform16.body.allowGravity = false;
_platform16.body.setImmovable(true);
...
var _platform18 = this.add
.sprite(230, config.height - 490, "destructPlatA")
.setScale(1.5,0.6);
...
var _platform18 = this.add
.sprite(230, config.height - 750, "destructPlatA")
.setScale(1.5,0.6);
this.destructivePlatforms.add(_platform18);
_platform18.body.allowGravity = false;
_platform18.body.setImmovable(true);
