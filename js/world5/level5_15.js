class level5_15 extends Phaser.Scene {
  ...
  create() {
    this.sound.stopAll();
    this.backgroundMusic = this.sound.add("Australia", { loop: false,volume:0.5 });
    this.backgroundMusic.play();
    //Cargamos las animaciones que tendra el juego
  
    this.add.sprite(config.width / 2, config.height / 2 - 82, "background15");
    //Cargamos las pools
    this.loadPools();
    ...
    this.createBall(config.width/2  -300, config.height - 500, 3, 1);
  ...
  createPlatforms() {
    var _platform1 = this.add
      .sprite(60, config.height/2+75, "normalPlat")
      .setScale(0.2,0.6);
    ...
    .sprite(190, config.height/2+75, "normalPlat")
    .setScale(0.6,0.6);
  ...
  .sprite(350, config.height/2+75, "normalPlat")
  .setScale(0.5,0.6);
...
.sprite(650, config.height/2+75, "normalPlat")
.setScale(2,0.6);
...
.sprite(1150, config.height/2+75, "normalPlat")
.setScale(2,0.6);
...
.sprite(1450+360, config.height/2+75, "normalPlat")
.setScale(0.2,0.6);
...
.sprite(1450+190, config.height/2+75, "normalPlat")
.setScale(0.6,0.6);
...
.sprite(1450, config.height/2+75, "normalPlat")
.setScale(0.6,0.6);
...
_platform8.body.setImmovable(true);
    ...
    .sprite(config.width / 2 - 650, config.height/2-150, "normalPlatRojaDestructive")
    .setScale(0.3,0.6);
...
.sprite(config.width / 2 + 150, config.height/2-280, "normalPlatRojaDestructive")
.setScale(0.3,0.6);
...
_platform11.body.setImmovable(true);
  ...
  createStairs() {
    var _ladder1 = this.add
      .sprite(config.width / 2 - 400, config.height - 300, "ladder")
      .setScale(4);
    ...
    var _ladder2 = this.add
      .sprite(config.width / 2 + 300, config.height - 360, "ladder")
      .setScale(4,1.5);
