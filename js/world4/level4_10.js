class level4_10 extends Phaser.Scene {
    constructor() {
      super({ key: "level4_10" });
    }
    ...
    createStairs() {
        ...
        var _ladder2 = this.add
          .sprite(config.width / 2 + 600, config.height - 230, "ladder")
          .setScale(4,1);
        ...
        .sprite(config.width / 2 - 0, config.height - 230, "ladder")
        .setScale(4,1);
      this.ladder.add(_ladder3);
      _ladder3.body.allowGravity = false;
      _ladder3.body.setImmovable(true);
  
      var _ladder4 = this.add
        .sprite(config.width / 2 + 150, config.height - 230, "ladder")
        .setScale(4,1);
      this.ladder.add(_ladder4);
      _ladder4.body.allowGravity = false;
    ...
    _ladder6.body.setImmovable(true);
      }
    ...
    createPlatforms() {
      ...
      var _platform2 = this.add
        .sprite(470, config.height / 2 + 220, "normalPlatV")
        .setScale(0.6,0.3);
      ...
      .sprite(1050, config.height / 2 + 220, "normalPlatV")
      .setScale(0.6,0.3);
  ...
  .sprite(1020, config.height / 2 + 220, "normalPlatV")
  .setScale(0.6,0.3);
...
_platform4.body.setImmovable(true);
    ...
    var _platform5 = this.add
      .sprite(1470, config.height / 2 + 220, "normalPlatV")
      .setScale(0.6,0.3);
    ...
    .sprite(1500, config.height / 2 + 220, "normalPlatV")
    .setScale(0.6,0.3);
