class level3_9 extends Phaser.Scene {
  constructor() {
    super({ key: "level3_9" });
  }
  ...
  create() {
    ...
    this.add.sprite(config.width / 2, config.height / 2 - 82, "background9");
    //Cargamos las pools
    this.loadPools();
  ...
  createPlatforms() {
    var _platform1 = this.add
      .sprite(55, config.height / 2-220, "normalPlatAPetita")
      .setScale(0.6);
  ...
  var _platform5 = this.add
    ...
    .sprite(config.width - 552, config.height-385, "normalPlat")
    .setScale(0.4, 0.6);
  ...
  .sprite(config.width / 2 + 290, config.height-385, "normalPlat")
  .setScale(0.4, 0.6);
...
.sprite(270, config.height-465, "normalPlat")
.setScale(0.4, 0.6);
