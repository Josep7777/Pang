class level2_5 extends Phaser.Scene {
  constructor() {
    super({ key: "level2_5" });
  }
  ...
  create() {
    ...
    this.loadAnimations();
    this.add.sprite(config.width / 2, config.height / 2 - 82, "background5");
    //Cargamos las pools
    this.loadPools();
    ...
    this.physics.add.collider(this.destructivePlatforms, this.player2);
