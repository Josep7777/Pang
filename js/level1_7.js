class level1_7 extends Phaser.Scene {
  constructor() {
    super({ key: "level1_7" });
  }
  ...
  create() {
    ...
    this.loadAnimations();
    this.add.sprite(config.width / 2, config.height / 2 - 100, "background7");
    //Cargamos las pools
    this.loadPools();
  ...
  createPlatforms() {
    ...
    var _platform2 = this.add
      .sprite(config.width / 2 - 200, config.height/2, "destructPlatA")
      .setScale(0.6);
